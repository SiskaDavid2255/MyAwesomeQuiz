...
import codingflow.com.QuizContract.*;
...
public class QuizDbHelper extends SQLiteOpenHelper {
...

    {
        Question q1 = new Question("Programming, Easy: A is correct",
                "A", "B", "C", 1,
                Question.DIFFUCLTY_EASY,
                Category.PROGRAMMING);
        insertQuestion(q1);

        Question q2 = new Question("Geography, Medium: B is correct",
                "A", "B", "C", 2,
                Question.DIFFUCLTY_MEDIUM,
                Category.GEOGRAPHY);
        insertQuestion(q2);

        Question q3 = new Question("Math, Hard: C is correct",
                "A", "B", "C", 3,
                Question.DIFFUCLTY_HARD,
                Category.MATH);
        insertQuestion(q3);

        Question q4 = new Question("Programming, Easy: A is correct",
                "A", "B", "C", 1,
                Question.DIFFUCLTY_EASY,
                Category.PROGRAMMING);
        insertQuestion(q4);

        Question q5 = new Question("Geography, Medium: B is correct",
                "A", "B", "C", 2,
                Question.DIFFUCLTY_MEDIUM,
                Category.GEOGRAPHY);
        insertQuestion(q5);
